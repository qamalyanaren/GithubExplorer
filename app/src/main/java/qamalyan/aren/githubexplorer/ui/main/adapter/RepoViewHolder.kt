...
class RepoViewHolder(
    view: View, private val onItemClicked: (repo: RepoUiEntity) -> Unit
    ...
    private var repo: RepoUiEntity? = null
    ...
    private fun showRepoData(repo: RepoUiEntity) {
        this.repo = repo
        name.text = repo.name
